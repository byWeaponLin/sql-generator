package com.weaponlin.dsl.design.transform;

import com.weaponlin.dsl.design.Operand;
import com.weaponlin.dsl.design.expression.*;
...
public abstract class TransformOperand extends Operand {
    ...
    public ExpressionOperand column(TransformOperand transformOperand) {
        return new ColumnExpressionOperand(transformOperand);
    }

    /**
     * TODO consider how to design aggregate function
     *
     * @return
     */
